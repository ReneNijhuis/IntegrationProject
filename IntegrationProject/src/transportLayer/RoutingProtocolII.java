...
import applicationLayer.MainII;
 ...
 */
public class RoutingProtocolII extends Observable implements Observer {
	...
	public RoutingProtocolII(MainII mainII, PacketRouter router) {	
		this.router = router;
		router.addObserver(this);
		clientName = mainII.name;
	}
