...
public class PrivateChatUIII extends JFrame implements KeyListener, ActionListener{ // <-- should extend JFrame: easier and more clear implementation
	...
	public PrivateChatUIII(MainII mainII){
		super("Chatbox");
		this.main = mainII;
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				((PrivateChatUIII) e.getWindow()).main.shutDown(true);
			}
