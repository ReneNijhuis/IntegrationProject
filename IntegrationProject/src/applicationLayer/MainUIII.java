...
public class MainUIII extends JFrame implements KeyListener, ActionListener{ // <-- should extend JFrame: easier and more clear implementation
	...
	public MainUIII(MainII mainII){
		super("Chatbox");
		this.main = mainII;
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				((MainUIII) e.getWindow()).main.shutDown(true);
			}
