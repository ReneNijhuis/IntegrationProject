...
import transportLayer.RoutingProtocolII;
 ...
 *
 */
public class MainII implements Observer {
	
	private MainUIII mainUI;
	private PrivateChatUIII chatUI;
	private LoginGUIII loginUI;
	private PacketRouter router;
	private PacketTracker tcp;
	private RoutingProtocolII routing;
	...
	public MainII() {
		// start LoginGUI
		loginUI = new LoginGUIII(this);
		// create UI (don't show it yet)
		mainUI = new MainUIII(this);	
		// create private UI (don't show it yet)
		chatUI = new PrivateChatUIII(this);
...
//			succes = router.sendPacket(Packet.generatePacket(fullMessage, routing.getMaxHops()));
	...
	public boolean tryLogin(String name, String pass){ 
		...
		routing = new RoutingProtocolII(this, router);
